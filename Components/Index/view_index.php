...
<? } ?>
	...
	In first run random array is generated then it put into cache. Refresh page to to see cached result in second array.
	<br>
	Please note that <em><?= SETTINGS_CACHE_DIR ?></em> must have write enabled rights (777) in case of absence
	<i>APC</i> cache.<br>
	<br>
	FormToken code is
	<pre>
	...
	<br>
	You can also try <a href="<?= SETTINGS_URLROOT ?>index.php?c=index&p=second">alternate action</a> for
	<b>index</b> component<br><br>
